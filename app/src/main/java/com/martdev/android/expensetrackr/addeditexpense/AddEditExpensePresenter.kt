...
class AddEditExpensePresenter(
    ...
    private var dailyExpense: DailyExpense
    ...
    override fun activityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        if (requestCode == AddEditExpenseFragment.REQUEST_DATE) {
            ...
            val date = Utils.getReadableDate(dateLong, context)
        ...
        dataSource.getDailyExpense(expenseId!!, object : ExpenseDataSource.LoadExpense<DailyExpense> {
            override fun onExpenseLoaded(expense: DailyExpense) {
                ...
                expense.run {
                    ...
                    taskView.showDate(expense.date.let { Utils.getReadableDate(it.time, context) })
